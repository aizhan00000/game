...
class AsyncToSync:
    ...
    finally exiting once the async task.py returns.
    """
...
class SyncToAsync:
    ...
    def thread_handler(self, loop, source_task, exc_info, func, *args, **kwargs):
        ...
        # Set the task.py mapping (used for the locals module)
        current_thread = threading.current_thread()
        if AsyncToSync.launch_map.get(source_task) == current_thread:
            # Our parent task.py was launched from this same thread, so don't make
    ...
    def get_current_task():
        ...
        Returns None if there is no task.py.
        """
        try:
